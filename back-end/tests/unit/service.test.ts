...
describe("POST /recommendations", () => {
    it("should get to the end given a valid body", async () => {
        ...
        const insert = jest.spyOn(recommendationRepository, "create").mockResolvedValue(null);
...
describe("POST /recommendations/id/upvote", () => {
    ...
    it("should update score given a valid recommendation", async () => {
        ...
        const upvote = jest.spyOn(recommendationRepository, "updateScore").mockResolvedValue(null);
...
describe("POST /recommendations/id/downvote", () => {
    ...
    it("should update score given a valid recommendation", async () => {
        ...
        const downvote = jest.spyOn(recommendationRepository, "updateScore").mockResolvedValue({
            id: 1,
            ...body,
            score: -1
        });
...
describe("GET /recommendations", () => {
    it("should get to findAll function from repository", async () => {
        const allRecommendations = jest.spyOn(recommendationRepository, "findAll").mockResolvedValue([]);
...
describe("GET /recommendations/top/amount", () => {
    it("should get to getAmountByScore function from repository", async () => {
        const topRecommendations = jest.spyOn(recommendationRepository, "getAmountByScore").mockResolvedValue([]);
...
describe("POST /reset", () => {
    it("should get to getAmountByScore function from repository", async () => {
        const truncate = jest.spyOn(recommendationRepository, "truncate").mockResolvedValue(null);
